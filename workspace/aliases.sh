...
alias composer:dev="COMPOSER=composer-dev.json composer"
...
# Modularity aliases
alias mod:reset="composer:dev run-script reinstall-local-test"
alias mod:ins="artisan modularity:install"
alias mod:dev="artisan modularity:dev --noInstall"
alias mod:build="artisan modularity:build --noInstall"
alias mod:rebuild="artisan modularity:build"
